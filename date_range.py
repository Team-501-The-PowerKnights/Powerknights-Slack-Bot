...
def week_range():
    ...
    start_date = datetime.datetime(
        start_date_lst[0], start_date_lst[1], start_date_lst[2]).isoformat()
    start_date_zulu = "".join([start_date, zulu_time])
    dates.append(start_date_zulu)
    ...
    end_date = datetime.datetime(
        end_date_lst[0], end_date_lst[1], end_date_lst[2]).isoformat()
    end_date_zulu = "".join([end_date, zulu_time])
    dates.append(end_date_zulu)
    return dates


# Testing:
# print(week_range())
# print((week_range()[0]).year())
